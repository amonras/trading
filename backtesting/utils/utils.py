...
def get_library():
    ...
    lib.get_position_history_size.restype = c_int
    lib.get_position_history_size.argtypes = [c_void_p]
    lib.get_position_history.restype = POINTER(c_int)
    lib.get_position_history.argtypes = [c_void_p]
